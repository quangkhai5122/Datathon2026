"""
Baseline Recursive v3.3 -- Projected Promo Calendar + Enhanced Features
=======================================================================
...
print(f"\n{'='*80}")
print("BASELINE RECURSIVE v3.3 -- PROJECTED PROMO CALENDAR")
print(f"{'='*80}")
...
def main():
    ...
    out = os.path.join(OUTPUT_DIR, 'submission_no_cogs_v3_3.csv')
